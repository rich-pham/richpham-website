...
export default function AboutSnapshot() {
  return (
    <section className="about-grid" style={{ display: 'grid', gridTemplateColumns: '2fr 3fr' }}>
      ...
      >
        <h2 style={{ fontSize: '40px', lineHeight: 1.15, fontWeight: 800, color: '#ffffff', marginBottom: '20px' }}>
          About Rich Pham
        </h2>

        <p style={{ fontSize: '16px', lineHeight: 1.7, color: 'rgba(255,255,255,0.85)', marginBottom: '28px' }}>
        ...
        <div style={{ marginBottom: '20px' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 800, color: '#F4D462', marginBottom: '8px', fontFamily: "'NunitoSans', sans-serif" }}>
            Business Scaling
          </h3>
