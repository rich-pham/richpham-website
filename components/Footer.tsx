            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {footerLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  style={{ fontSize: '14px', color: 'rgba(255,255,255,0.65)', textDecoration: 'none', transition: 'color 0.2s ease' }}
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: '28px' }}>
          <div className="footer-bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <a
              ...
              style={{ color: 'rgba(255,255,255,0.65)', textDecoration: 'none', transition: 'color 0.2s ease', display: 'flex', alignItems: 'center' }}
              onMouseEnter={(e) => (e.currentTarget.style.color = '#ffffff')}
              onMouseLeave={(e) => (e.currentTarget.style.color = 'rgba(255,255,255,0.65)')}
            >
              <LinkedInIcon />
