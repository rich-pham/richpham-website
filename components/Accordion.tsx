...
const tabs = [
  ...
  },
  {
    ...
    when: {
      ...
      items: [
        'Not to push harder',
        'But to reset how the organization leads and decides',
      ],
    },
  },
];
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'start' }}>
          ...
          >
            <Image
              ...
              style={{ objectFit: 'cover', borderRadius: '6px', transition: 'opacity 0.3s ease' }}
            />
          </div>
        </div>
        ...
        >
          ...
          <ul style={{ margin: '0 0 16px', paddingLeft: '20px' }}>
            {['Clarify decisions', 'Build leadership confidence', 'Remove the bottlenecks that limit scale'].map((item) => (
              <li
                key={item}
                style={{ fontSize: '16px', lineHeight: 1.6, color: 'rgba(255,255,255,0.80)', marginBottom: '4px' }}
              >
                {item}
              </li>
            ))}
